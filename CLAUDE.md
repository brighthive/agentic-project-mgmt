...
| **Release automation workflow** | `.github/workflows/sprint-release-v2.yml` |
| **Release automation script** | `scripts/sprint_release.py` |
...
├── .github/workflows/
│   └── sprint-release-v2.yml    # CI: sprint release automation
...
│       ├── 1/                   # stats.json, tickets.json, SUMMARY.md
│       ├── 2/                   # (same pattern)
│       ├── 3/                   # + RELEASE_NOTES.md, MARKETING_RELEASE_NOTES.md
│       ├── 4/                   # PLAN.md
│       └── 5/                   # RELEASE_NOTES.md, MARKETING_RELEASE_NOTES.md, VALIDATION_REPORT.md
├── scripts/
│   └── sprint_release.py        # Production release notes generator
├── notion/
...
3. Generated by `.github/workflows/sprint-release-v2.yml`
...
| `RELEASE_NOTES.md` | CI-generated | Technical release notes per repo |
| `MARKETING_RELEASE_NOTES.md` | CI-generated | Customer-facing highlights |
| `PLAN.md` | Manual | Sprint goals, planned tickets, dependencies |
| `VALIDATION_REPORT.md` | CI-generated | Tickets Done without linked PRs |
