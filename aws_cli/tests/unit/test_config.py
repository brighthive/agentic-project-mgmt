...
def test_config_defaults():
    ...
    assert config.profiles["dev"] == "brighthive-dev"
    assert config.profiles["stg"] == "brighthive-stg"
    assert config.profiles["prod"] == "brighthive-prod"
...
def test_config_env_overrides():
    ...
    assert config.profiles["stg"] == "brighthive-stg"  # unchanged
