    ...
    USE [LoopCapitalAM];
    EXEC('
        CREATE OR ALTER VIEW "dbo"."holdings_current__dbt_tmp__dbt_tmp_vw" AS 
...
EXEC('
            SELECT * INTO "LoopCapitalAM"."dbo"."holdings_current__dbt_tmp" FROM "LoopCapitalAM"."dbo"."holdings_current__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS "dbo"."holdings_current__dbt_tmp__dbt_tmp_vw"')
    ...
    if EXISTS (
        ...
        WHERE name = 'dbo_holdings_current__dbt_tmp_cci'
        AND object_id=object_id('"dbo"."holdings_current__dbt_tmp"')
    )
    DROP index "dbo"."holdings_current__dbt_tmp".dbo_holdings_current__dbt_tmp_cci
    CREATE CLUSTERED COLUMNSTORE INDEX dbo_holdings_current__dbt_tmp_cci
    ON "dbo"."holdings_current__dbt_tmp"
